                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden flex-1">
                    ...
                    <div class="p-5 flex items-center gap-5">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <p class="text-sm text-gray-700">
                                Kelas: <span
                                    class="font-semibold text-gray-900">{{ $user->kelas?->nama_kelas ?? '-' }}</span>
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="flex items-center gap-2 select-none cursor-default">
                                ...
                                <span
                                    class="w-4 h-4 rounded border-2 flex items-center justify-center flex-shrink-0
                                         ...
                                         @else bg-white border-gray-400 @endif">
                                    @if ($checked)
                    ...
                    <div class="pt-2 border-t border-gray-100 mt-auto">
                        ...
                        @else
                            <div class="flex items-center gap-1.5">
                                ...
                                <span class="text-xs font-medium text-green-600">Semua kebiasaan hari ini sudah
                                    diisi!</span>
                            </div>
                        @endif
                    </div>
