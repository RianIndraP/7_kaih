...
<body class="bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-blue-200/50 w-full max-w-md p-8 transform hover:scale-[1.01] transition-transform duration-300">
        ...
        <h1 class="text-3xl font-bold text-gray-900 text-center mb-6 bg-gradient-to-r from-blue-600 to-indigo-700 bg-clip-text text-transparent">Buat Password Baru</h1>
        ...
        <form class="space-y-5" method="POST" action="{{ route('create-new-password') }}">
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <button type="button" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-blue-600 transition-colors toggle-password">
        ...
        <div class="mt-6 text-center">
            <a href="{{ route('verify-data') }}" class="text-sm font-semibold text-gray-600 hover:text-gray-800 hover:underline transition-colors flex items-center justify-center gap-1">
