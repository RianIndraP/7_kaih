...
<body class="bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-blue-200/50 w-full max-w-md p-8 transform hover:scale-[1.01] transition-transform duration-300">
        ...
        <h1 class="text-3xl font-bold text-gray-900 text-center mb-2 bg-gradient-to-r from-blue-600 to-indigo-700 bg-clip-text text-transparent">Selamat Datang</h1>
        ...
        <form class="space-y-5" method="POST" action="{{ route('login') }}">
            ...
            <div class="flex justify-end">
                ...
                <a href="{{ route('forgot-password') }}" class="text-sm font-semibold text-blue-600 hover:text-blue-800 hover:underline transition-colors">
                    Lupa password?
                </a>
            </div>
