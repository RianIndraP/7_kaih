...
<body
    class="bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100 min-h-screen flex items-center justify-center p-4">

    <!-- Login Card -->
    <div
        class="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-blue-200/50 w-full max-w-md p-8 transform hover:scale-[1.01] transition-transform duration-300">

        <!-- Logo/Icon Section -->
        <div class="flex justify-center mb-6">
            <div
                class="w-20 h-20 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl flex items-center justify-center shadow-xl ring-4 ring-blue-100">
                <img src="{{ asset('img/logo-1.png') }}" alt="">
            </div>
        </div>

        <h1
            class="text-3xl font-bold text-gray-900 text-center mb-2 bg-gradient-to-r from-blue-600 to-indigo-700 bg-clip-text text-transparent">
            Selamat Datang</h1>
        ...
        <form class="space-y-5" method="POST" action="{{ route('login') }}">
            ...
            @if ($errors->any())
                <div
                    class="bg-gradient-to-r from-red-50 to-rose-50 border border-red-200 text-red-800 px-4 py-3 rounded-xl shadow-sm">
