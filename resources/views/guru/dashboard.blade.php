        ...
        <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-100 shadow-md overflow-hidden flex flex-col">
            ...
            <div class="p-6 flex items-center gap-6 flex-1">
                ...
                <div class="flex-shrink-0">
                    <div class="w-32 h-32 rounded-2xl bg-gradient-to-br from-blue-400 to-indigo-500 border-4 border-white shadow-lg
                                flex items-center justify-center overflow-hidden relative">
                        <img src="{{ asset('storage/profile_photos/ghuN7v17eWniR2KkuGIL9EiYpm54JzWFI4eXBfKq.jpg') }}"
        ...
        <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-100 shadow-md overflow-hidden flex flex-col">
            ...
            <div class="p-4 flex flex-col gap-2 max-h-50 overflow-y-auto flex-1">
                @forelse ($siswaBlumMengisi as $siswa)
                    <div class="flex items-center gap-3 bg-white/60 border border-blue-200 rounded-lg px-4 py-3
        ...
        <div class="p-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <a href="{{ route('guru.pelaporan') }}"
               class="flex items-center gap-3 bg-white/60 border border-blue-200 hover:border-blue-400
                ...
                <div class="w-10 h-10 bg-gradient-to-br from-blue-400 to-blue-600 rounded-lg flex items-center
