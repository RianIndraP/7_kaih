...
@section('content')
    ...
    <div class="max-w-[1100px] mx-auto space-y-4">
        ...
        <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden fu-1">
            ...
            <div class="p-4 grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                ...
                <div class="field-row" style="opacity:.75;">
                    <span class="field-label-sm">NIP</span>
                    <span class="field-sep">:</span>
                    <input type="text" id="p_nip" value="{{ $user->nip ?? '-' }}" class="field-input" readonly />
                </div>
                <div class="field-row" style="opacity:.75;">
                    <span class="field-label-sm">NIK</span>
                    <span class="field-sep">:</span>
                    <input type="text" id="p_nik" value="{{ $user->nik ?? '-' }}" class="field-input" readonly />
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function simpanProfil() {
            ...
            if (!alamat || alamat === 'Belum ada lokasi dipilih') { tampilkanToast('Silakan pilih lokasi di peta!', 'red'); return; }
        ...
        document.addEventListener('DOMContentLoaded', function () { setTimeout(initPreviewMap, 300); });
    </script>
