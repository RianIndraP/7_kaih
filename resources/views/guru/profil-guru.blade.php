...
@section('content')
    ...
    <div class="min-h-screen bg-gray-50">
        <div class="px-3 sm:px-4 md:px-6 py-4 max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto">
            {{-- Header yang compact --}}
            <div
                class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6 shadow-md text-white">
            ...
            {{-- ===== PROFILE CARD ===== --}}
            <div
                class="bg-white rounded-lg border border-gray-100 shadow-sm p-3 sm:p-4 md:p-5 mb-4 sm:mb-5 hover:shadow-md transition-shadow">
                <div class="flex flex-col lg:flex-row gap-4 sm:gap-5 items-center lg:items-start">
                    ...
                    <div class="flex flex-col items-center gap-2 sm:gap-3 flex-shrink-0">
                        <div class="relative">
                            ...
                            <div
                                class="absolute -bottom-1 -right-1 w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center shadow-md">
                    ...
                    <div class="flex-1 w-full">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                            ...
                            <div class="bg-gray-50 rounded-md p-2 sm:p-3 hover:bg-gray-100 transition-colors">
                                <label class="text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1 block">Nama
                                    Lengkap</label>
                            ...
                            <div class="bg-gray-50 rounded-md p-2 sm:p-3 hover:bg-gray-100 transition-colors">
                                <label
                                    class="text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1 block">Tempat
                                    Lahir</label>
                            ...
                            <div class="bg-gray-50 rounded-md p-2 sm:p-3 hover:bg-gray-100 transition-colors">
                                <label
                                    class="text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1 block">Tanggal
                                    Lahir</label>
                            ...
                            <div class="bg-gray-50 rounded-md p-2">
                                <label
                                    class="text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1 block">NIP</label>
                            ...
                            <div class="bg-gray-50 rounded-md p-2">
                                <label
                                    class="text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1 block">NIK</label>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-3 mb-4 sm:mb-5">
                ...
                {{-- Data Kepegawaian --}}
                <div
                    class="bg-white rounded-lg border border-gray-100 shadow-sm p-2 sm:p-3 hover:shadow-md transition-shadow">
                    <div class="flex items-center gap-2 mb-2 sm:mb-3">
                        <div
                            class="w-6 h-6 sm:w-7 sm:h-7 bg-gradient-to-br from-emerald-400 to-green-500 rounded-lg flex items-center justify-center">
                    ...
                    <div class="space-y-1.5 sm:space-y-2">
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Status
                                Pegawai</label>
                            <input type="text" id="f_status_guru" value="{{ $guru->status_pegawai ?? '-' }}"
                                placeholder="Status guru" class="w-full px-2 py-1.5 sm:px-3 sm:py-2 bg-gray-50 border border-gray-200 rounded-md text-sm text-gray-500 font-medium cursor-not-allowed
                                      focus:outline-none" readonly />
                        </div>

                        <div>
                            <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Jenis
                                Kelamin</label>
                            <select id="f_gender" class="w-full px-2 py-1.5 sm:px-3 sm:py-2 bg-gray-50 border border-gray-200 rounded-md text-sm text-gray-700
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Unit
                                Kerja</label>
                            <input type="text" id="f_unit_kerja" value="{{ $guru->unit_kerja ?? '' }}"
                                placeholder="Unit kerja" class="w-full px-2 py-1.5 sm:px-3 sm:py-2 bg-gray-50 border border-gray-200 rounded-md text-sm text-gray-800
                                      focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-400 focus:bg-white
                ...
                <div
                    ...
                    <div class="flex items-center gap-2 mb-2 sm:mb-3">
                        <div
                            class="w-6 h-6 sm:w-7 sm:h-7 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-lg flex items-center justify-center">
                            <svg class="w-3.5 h-3.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="space-y-1.5 sm:space-y-2">
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Nomor
                                Telepon</label>
                            <input type="tel" id="f_hp" value="{{ $user->no_telepon ?? '' }}"
                                placeholder="Nomor yang dapat dihubungi" class="w-full px-2 py-1.5 sm:px-3 sm:py-2 bg-gray-50 border border-gray-200 rounded-md text-sm text-gray-800
                        ...
                        <div>
                            <label
                                class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Email</label>
                            <input type="email" id="f_email" value="{{ $user->email ?? '' }}" placeholder="Email" class="w-full px-2 py-1.5 sm:px-3 sm:py-2 bg-gray-50 border border-gray-200 rounded-md text-sm text-gray-800
                                      focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-400 focus:bg-white
                                      hover:border-gray-300 transition-all" />
                        ...
                        {{-- MAP PREVIEW --}}
                        <div>
                            <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Lokasi
                                Alamat</label>
                            ...
                            <div id="mapPreviewWrapper" onclick="openMapModal()"
                                ...
                                <div
                                    ...
                                    <div
                                        class="w-5 h-5 bg-white/20 backdrop-blur-sm rounded-md flex items-center justify-center">
                            ...
                            <div id="addressDisplay" class="mt-2 text-xs text-gray-700 bg-gradient-to-r from-gray-50 to-blue-50 border border-gray-200
        ...
        <div class="bg-white rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden" onclick="event.stopPropagation()">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-5 pb-5 pt-0">
                ...
                <div class="flex items-center gap-2">
                    {{-- Tombol Hapus Lokasi --}}
                    <button id="btnHapusLokasi" onclick="clearLocation()" class="flex-shrink-0 bg-red-100 hover:bg-red-200 text-red-600 text-sm font-medium
                                   px-4 py-2.5 rounded-lg transition-colors {{ empty($user->latitude) ? 'hidden' : '' }}">
                        Hapus Lokasi
                    </button>

                    {{-- Tombol Konfirmasi --}}
                    <button onclick="confirmLocation()" class="flex-shrink-0 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium
    ...
    {{-- ===== TOAST ===== --}}
    <div id="toast" class="fixed top-5 right-5 z-[99999] flex items-center gap-2 text-white text-sm font-medium
