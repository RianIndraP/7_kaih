...
<style>
    ...
    #mapFull { width: 100%; height: 380px; }
</style>
        ...
        <div class="flex flex-col sm:flex-row gap-5 items-start">
            ...
            <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-1">
                ...
                <div class="flex items-center border-b border-gray-100 py-2">
                    ...
                    <span class="text-xs text-gray-400 mx-2">:</span>
                    <input type="text" id="p_tempat_lahir"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <div class="space-y-3">
                ...
                <div>
                    <input type="text" id="f_status_guru"
                           value="{{ $guru->status_pegawai ?? '' }}"
...
<script>
/* ── State peta ─────────────────────────────────────────── */
var selLat     = {{ $user->latitude  ?? 5.5489  }};
var selLng     = {{ $user->longitude ?? 95.3238 }};
...
document.getElementById('photoInput').addEventListener('change', function () {
    ...
    reader.onload = function (e) {
        ...
        circle.innerHTML = '<img src="' + e.target.result + '" alt="Foto Guru" class="w-full h-full object-cover"/>';
    };
...
function simpanProfil() {
    var data = {
        ...
        status_guru   : document.getElementById('f_status_guru').value,
        gender        : document.getElementById('f_gender').value,
        unit_kerja    : document.getElementById('f_unit_kerja').value,
    ...
    .then(function (result) {
        tampilkanToast(
            result.success ? 'Profil berhasil disimpan!' : ('Error: ' + (result.message || 'Terjadi kesalahan')),
