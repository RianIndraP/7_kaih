...
<style>
    ...
    .inline-edit:hover { background: #f0f9ff; }
    .inline-edit:focus { background: #eff6ff; color: #1d4ed8; }
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        ...
        <div class="space-y-3">
            @foreach ([
                ['id'=>'f_hobi',  'label'=>'Hobi',            'val'=>$user->hobi ?? '',             'ph'=>'Hobi kamu...'],
                ['id'=>'f_cita',  'label'=>'Cita-cita',        'val'=>$user->cita_cita ?? '',        'ph'=>'Cita-cita kamu...'],
                ['id'=>'f_teman', 'label'=>'Teman terbaik',    'val'=>$user->teman_terbaik ?? '',    'ph'=>'Nama teman terbaik...'],
                ['id'=>'f_makan', 'label'=>'Makanan kesukaan', 'val'=>$user->makanan_kesukaan ?? '', 'ph'=>'Makanan favorit...'],
                ['id'=>'f_warna', 'label'=>'Warna kesukaan',   'val'=>$user->warna_kesukaan ?? '',   'ph'=>'Warna favorit...'],
            ] as $field)
                <div>
        ...
        <div class="space-y-3">
            ...
            <div>
                ...
                <div id="mapPreviewWrapper"
                    ...
                    <div class="absolute inset-x-0 bottom-0 bg-black/50 group-hover:bg-black/65
...
function reverseGeocode(lat, lng) {
    ...
    geocodeTimer = setTimeout(function () {
        fetch('https://nominatim.openstreetmap.org/reverse?lat=' + lat + '&lon=' + lng + '&format=json&accept-language=id')
            ...
            .catch(function () {
                document.getElementById('coordAddr').textContent = lat.toFixed(5) + ', ' + lng.toFixed(5);
            });
    }, 600);
}
...
document.getElementById('photoInput').addEventListener('change', function () {
    ...
    reader.onload = function (e) {
        ...
        circle.innerHTML = '<img src="' + e.target.result + '" alt="Foto Siswa" class="w-full h-full object-cover"/>';
    };
...
function saveProfile() {
    var data = {
        ...
        kelas        : document.getElementById('p_kelas').value,
        nisn         : document.getElementById('p_nisn').value,
        tempat_lahir : document.getElementById('p_tempat_lahir').value,
        tanggal_lahir: document.getElementById('p_tanggal_lahir').value,
        jk           : document.getElementById('p_jk').value,
        hobi         : document.getElementById('f_hobi').value,
        cita         : document.getElementById('f_cita').value,
        teman        : document.getElementById('f_teman').value,
        makan        : document.getElementById('f_makan').value,
        warna        : document.getElementById('f_warna').value,
        gender       : document.getElementById('f_gender').value,
        hp           : document.getElementById('f_hp').value,
        ortu         : document.getElementById('f_ortu').value,
        email        : document.getElementById('f_email').value,
        alamat       : document.getElementById('addressDisplay').innerText.trim(),
        latitude     : selLat,
        longitude    : selLng,
    };
