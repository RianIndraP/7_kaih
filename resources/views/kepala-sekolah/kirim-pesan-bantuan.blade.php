        ...
        <div class="bantuan-hero rounded-2xl px-6 py-5 fu-0">
            ...
            <div class="relative z-10 flex items-center gap-4 flex-wrap">
                ...
                <div>
                    ...
                    <p class="text-white/72 text-[12.5px]">Ada masalah atau pertanyaan? Kami siap membantu Anda</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div class="lg:col-span-2 bg-white border border-gray-200 rounded-2xl overflow-hidden fu-1">
                ...
                <div class="p-5">
                    ...
                    <form method="POST" action="{{ route('kepala-sekolah.kirim-pesan-bantuan.store') }}" class="space-y-5"
                        id="bantuanForm">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="text" name="judul" value="{{ old('judul') }}"
                                placeholder="Tuliskan judul pesan Anda..." maxlength="100"
                        ...
                        <div>
                            ...
                            <textarea name="isi" rows="6" id="isiPesan"
                                placeholder="Ceritakan masalah atau pertanyaan Anda secara detail agar kami bisa membantu dengan tepat..."
            ...
            <div class="flex flex-col gap-4 fu-2">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                    ...
                    <div class="p-4 space-y-2.5">
                        ...
                        <div class="flex items-center gap-3 p-3 rounded-xl"
                            ...
                            <div class="w-10 h-10 rounded-full flex items-center justify-center shrink-0 overflow-hidden"
                            ...
                            <div>
                                ...
                                <p class="text-[11px] font-semibold text-indigo-600">Kepala Sekolah</p>
                            </div>
                        </div>

                        @foreach ([['label' => !empty($user->nip) ? 'NIP' : 'NIK', 'val' => !empty($user->nip) ? ($user->nip ?? '-') : ($user->nik ?? '-')], ['label' => 'Email', 'val' => $user->email ?? '-']] as $row)
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden fu-3">
                    ...
                    <div class="p-4 space-y-2.5">
                        @foreach ([['icon' => '1', 'text' => 'Pilih kategori yang paling sesuai dengan masalah Anda'], ['icon' => '2', 'text' => 'Tuliskan judul singkat yang menggambarkan masalah'], ['icon' => '3', 'text' => 'Jelaskan masalah secara detail di bagian isi pesan'], ['icon' => '4', 'text' => 'Klik "Kirim" dan tim kami akan segera menghubungi Anda']] as $step)
                            <div class="flex items-start gap-3 p-2.5 rounded-xl"
                                ...
                                <div class="w-6 h-6 rounded-full flex items-center justify-center shrink-0 mt-0.5 text-[11px] font-extrabold text-white"
