...
@section('content')
                ...
                <div class="p-5">
                    ...
                    <form method="POST" action="{{ route('student.ganti-password.update') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" value="{{ $user->nisn ?? '' }}" readonly class="fancy-input" />
                        </div>
                        ...
                        {{-- Syarat password --}}
                        <div
                            class="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-xl p-3 space-y-1.5">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden fu-2">
                    <div class="section-header">
                        ...
                        <span class="text-[13px] font-bold text-gray-900">Data Siswa</span>
                    </div>
                    ...
                    <div class="p-4 space-y-2.5">
                        ...
                        {{-- Avatar + nama --}}
                        <div
                            class="flex items-center gap-3 p-3 bg-gradient-to-r from-blue-50 to-indigo-50
                        border border-blue-100 rounded-xl mb-3">
                            ...
                            <div>
                                ...
                                <p class="text-[11.5px] text-indigo-600 font-semibold">
                                    {{ $user->kelas?->nama_kelas ?? '-' }}</p>
                            </div>
                        </div>

                        <div class="data-row">
                            <span class="data-row-label">NISN</span>
                            <span class="data-row-val">{{ $user->nisn ?? '-' }}</span>
                        </div>
                        ...
                        <div class="data-row">
                            <span class="data-row-label">Kelas</span>
                            <span class="data-row-val">{{ $user->kelas?->nama_kelas ?? '-' }}</span>
                        </div>
                        ...
                        <div class="data-row">
                            <span class="data-row-label">Guru Wali</span>
                            <span class="data-row-val">{{ $user->guruWali->name ?? '-' }}</span>
                        </div>
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden fu-3">
                    ...
                    <div class="p-4 space-y-2.5">
                        @foreach ([['Gunakan kombinasi huruf besar, kecil, angka, dan simbol', '🔡'], ['Jangan gunakan tanggal lahir atau nama sebagai password', '🚫'], ['Ganti password secara berkala setiap 3–6 bulan', '🔄'], ['Jangan bagikan password kepada siapapun', '🤫']] as $tip)
                            <div
                                class="flex items-start gap-2.5 p-2.5 rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100">
    ...
    <script>
        ...
        function checkStrength(val) {
            ...
            // Update tips
            setTip('tip_len', hasLen);
            setTip('tip_upper', hasUpper);
            setTip('tip_num', hasNum);
            setTip('tip_sym', hasSym);
            ...
            const configs = [{
                ...
                {
                    w: '100%',
                    bg: 'linear-gradient(90deg,#2563eb,#4f46e5)',
                    text: 'Kuat 💪',
                    col: '#2563eb'
                },
            ];
        ...
        function setTip(id, ok) {
            ...
            const dot = el.querySelector('.tip-dot');
        ...
        function checkMatch() {
            const pw1 = document.getElementById('pw_baru').value;
            const pw2 = document.getElementById('pw_konfirm').value;
        ...
        // Also trigger match check when password baru changes
        document.getElementById('pw_baru').addEventListener('input', checkMatch);
    </script>
